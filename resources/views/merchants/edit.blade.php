        ...
        <div class="col-md-6" style="margin-left:350px;">
            ...
            <div class="row">
		        <div class="form-group">
		            ...
		            <input type="text" name="name" value="{{ $merchants->shop_name ?? '' }}" class="form-control" placeholder="Shop Name">
		        </div>
		        <div class="form-group">
            ...
            <div class="row mt-2">
		        ...
		        <div class="form-group">
					...
					<button type="button" class=" btn btn-success mb-2" id="add" name="add">Add new +</button>
					@foreach ($locations as $loc)
						<input  class="form-control" id="location" name="location[]" value="{{ $loc->name }}"  placeholder="Enter Location"/>
						<div class="form-group mt-2"><button type="button" class="btn btn-danger remove mb-2">-</button></div>
					@endforeach
                    <div id="dynamic_row">
                    </div>
		        </div>
